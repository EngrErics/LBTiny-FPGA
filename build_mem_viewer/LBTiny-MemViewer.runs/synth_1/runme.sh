...
HD_PWD='C:/Workspace/Xilinx/LBTiny-MemBus/build_mem_viewer/LBTiny-MemViewer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lbtiny_mem_viewer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lbtiny_mem_viewer_top.tcl
