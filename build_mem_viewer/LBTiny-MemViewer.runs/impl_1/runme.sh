...
HD_PWD='C:/Workspace/Xilinx/LBTiny-MemBus/build_mem_viewer/LBTiny-MemViewer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lbtiny_mem_viewer_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lbtiny_mem_viewer_top.tcl -notrace
