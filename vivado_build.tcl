...
set rtl_files [list \
    [file join $src_dir "lbtiny_bus_slave.v"] \
...
# Memory init used by $readmemh. For synthesis, Vivado only needs the .mem file
# in sources_1 and marked as a Memory Initialization File. Implementation uses
# the synthesized netlist/INIT values.
