...
proc check_run_complete {run_name label} {
    ...
    if {[get_property PROGRESS $run_obj] ne "100%" || ![string match -nocase "*Complete*" $status]} {
        puts "ERROR: $label failed. Run $run_name status: $status"
        exit 1
    }
    puts "  $label OK"
}
...
wait_on_run synth_1
check_run_complete synth_1 "synth"

puts "Implementing and writing bitstream..."
launch_runs impl_1 -to_step write_bitstream -jobs 4
wait_on_run impl_1
check_run_complete impl_1 "impl"
